...
An OSC client for PureData and Max, to be used with the [pdj] and [mxj] objects to embed java classes in PD / Max. It is (C)opyright 2010 by Hanns Holger Rutz. All rights reserved. PDOSCClient is released under the GNU Lesser General Public License (see licenses folder) and comes with absolutely no warranties. To contact the author, send an email to @contact at sciss.de@
